...
const Table = styled.table`
  ...
  tbody{
     background: linear-gradient(180deg, #C9F3F5 0%, rgba(170, 230, 234, 0) 100%);
      ...
      <Table>
        ...
        <tbody>
          <tr>
            ...
            {packages.map((pkg) => (
              <td key={pkg.paket}>
                {pkg.chat === truepic ? <img src={truepic} alt="true" /> : <img src={falsepic} alt="false" />}
              </td>
            ))}
          </tr>
          <tr>
            ...
            {packages.map((pkg) => (
              <td key={pkg.paket}>
                {pkg.drugs === truepic ? <img src={truepic} alt="true" /> : <img src={falsepic} alt="false" />}
              </td>
            ))}
          </tr>
          <tr>
            ...
            {packages.map((pkg) => (
              <td key={pkg.paket}>
                {pkg.lab === truepic ? <img src={truepic} alt="true" /> : <img src={falsepic} alt="false" />}
              </td>
            ))}
          </tr>
          <tr>
            ...
            {packages.map((pkg) => (
              <td key={pkg.paket}>
                {pkg.outpatient === truepic ? <img src={truepic} alt="true" /> : <img src={falsepic} alt="false" />}
              </td>
            ))}
          </tr>
          <tr>
            ...
            {packages.map((pkg) => (
              <td key={pkg.paket}>
                {pkg.inpatient === truepic ? <img src={truepic} alt="true" /> : <img src={falsepic} alt="false" />}
              </td>
            ))}
          </tr>
        </tbody>
