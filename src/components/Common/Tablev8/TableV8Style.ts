  ...
  .table {
    ...
    .tr {
      ...
      padding: ${({ paddingStyle }) =>
        paddingStyle!.tr || defaultPaddingStyle.tr};
      ${({ clickableRow }) =>
        clickableRow === true ? `cursor: pointer;` : ""};
    ...
    .td {
      padding: ${({ paddingStyle }) =>
        paddingStyle!.td || defaultPaddingStyle.td};
      font-size: 14px;
    }
    .th,
    .td {
    ...
    .th {
      flex: 1 0 auto;
      padding: ${({ paddingStyle }) =>
        paddingStyle!.th || defaultPaddingStyle.th};
      font-size: 12px;
