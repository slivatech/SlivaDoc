    ...
    <Container style={{ background: "rgba(153, 178, 198, 0.2)" }}>
      ...
      >
        ...
        <div>
          <BaseButton
            ...
            iconStart={
              <i
                className="fa-light fa-plus fa-lg"
                style={{ color: "#fff" }}
              ></i>
            }
            textColor="#fff"
        ...
        {update && (
          ...
          >
            <div style={{ padding: "1.5rem" }}>
              <div
                style={{ display: "flex", columnGap: "3rem", margin: "2rem 0" }}
              >
                <button
                  style={{
                    border: "none",
              ...
              <Form>
                ...
                <div className="submit">
                  <BaseButton
                    text="Upload"
                    iconStart={<img src={downloadIcon} alt="" width={20} />}
                    textColor="#fff"
                    color="#3A36DB"
                    fontSize="14px"
                    radius="10px"
      ...
      <Content>
        <div className="table">
          ...
          >
            <h5>List Article</h5>
            <Link to="/" style={{ fontSize: "12px", textDecoration: "none" }}>
              See more
            </Link>
          </div>
        ...
        <div className="chart">
          <div style={{ padding: "30px" }}>
            ...
            <BarChartVertical data={months} left="name" right="total" />
          </div>
        </div>
      </Content>
    </Container>
  ...
  const alertColumn = React.useMemo(
    () => [
      ...
      table.accessor("category", {
        ...
        enableSorting: false,
        header: "Category",
        cell: (props: any) => <p>{props.row.original.category}</p>,
      }),
