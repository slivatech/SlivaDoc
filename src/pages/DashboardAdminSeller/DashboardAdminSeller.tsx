...
import {Container, ImageColumn, Content,  Chart, StatusColumn, Name, AreaChartContainer, TopConsultContainer, BannerContainer } from './DashboardAdminSellerStyle'
...
export default DashboardAdminSeller;
